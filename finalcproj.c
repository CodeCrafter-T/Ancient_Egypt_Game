    ...
    void dis_hit_point(int hit_point1,int hit_point2,char *name,int h1,int h2);
    void dis_stats(st *p,char *name);
    void dis_attribute(st *p);
    ...
    void dis_item(int item[],st *player,st *boss);
    void change(st *player,st *boss,int ch,int cat);
    ...
    void battle_mechanincs()      //triple check the code
    {
        char name[20];
    ...
    typedef struct _scene {
        ...
        bool option1;
        bool option2;
        char option1Text[1000];
        char option2Text[1000];
        bool kill;
        bool active;
    } Scene;
    ...
    void earth_city() {
        ...
        strcpy(op1[3].scene,"HAHA, When the aggressive flames of fire can not kill you, who am I? It is the decision of that great AMUN top keep you alive. It’s the decision of that great AMUN top keep you alive. You are the chosen one.would you like to save this kingdom");
        ...
        strcpy(op1[4].option2Text,"no");
        op1[4].active=false;

        strcpy(op1[5].scene,"Thanks for your help.YOU: Your majesty, please guide me along my way to save our kingdom. The temple on the outskirts of the town has a weird aura surrounding it. Maybe, they are defiled. Let’s start by checking upon them");
    ...
    Scene op1[MAX_SCENES];      //array of structures
        ...
        strcpy(op1[7].scene,"You give him then scroll. Thoth opens the scroll. Thoth: A great evil resides in an island far away. You need to find Imhotep- the magician who is facing the trials of underworld right now. But you are very weak to enter the underworld. So before entering it you, must have these four skills: Terraforce- the one you already have. Ethicore- it will show you the right path. Vortex- you can produce tornados of different intensity. Aquamansion- Protects from extreme heat and Produce tides of different intensity. I will bequeath you the ability of judgement- the Ethicore. You: Where will I get the other two abilities? Thoth: You will get to know yourself, just use the abilities you have");
        op1[7].active=false;
        ...
        strcpy(op1[9].scene,"Thoth gives eye of horus. You give him the scroll");
        op1[9].active=false;
    ...
    op1[20].active = false;
    strcpy(op1[21].scene,"King: Actually, there is. Our kingdom's god Tefnut has gone missing. Without her guidance, our people are lost. I need you to find her. This ancient scroll contains clues that will lead you to him.");
    ...
    strcpy(op1[22].option1Text,"Option1: Wisdom city");
...
int puzzle() {
  ...
  earth_city();
  wisdom_city();
  printf("which city do you wantr to go next?");
  printf("1. Water city\n2. Wind city\n");
  int choice_city;
  scanf("%d",&choice_city);
  if (choice_city == 1){
